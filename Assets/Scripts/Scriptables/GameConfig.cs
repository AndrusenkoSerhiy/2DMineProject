...
namespace Scriptables {
  ...
  public class GameConfig : ScriptableObject {
    ...
    [Header("Playable Area Parameters")]
    [SerializeField] private int playerAreaWidth = 80;
